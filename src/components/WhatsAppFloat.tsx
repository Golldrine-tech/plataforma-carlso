...
/** Botão flutuante de WhatsApp com pulso/glow discreto. */
const WhatsAppFloat = () => {
  return (
    <motion.a
      ...
      className="group fixed bottom-5 right-5 z-50 flex items-center gap-3 rounded-full bg-[#25D366] p-4 text-white shadow-lg shadow-black/40 sm:bottom-6 sm:right-6"
    ...
    >
      ...
      <span className="hidden pr-1 text-sm font-semibold sm:inline-block">Fale conosco</span>
    </motion.a>
  );
};
